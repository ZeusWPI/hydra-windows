...
namespace Hydra.Views {
    ...
    public sealed partial class Shell : Page {
        ...
        /// <summary>
        /// The Frame containing the content
        /// </summary>
        ...
        public Shell() {
            ...
            // Navigation Menu
            NavMenuList.ItemsSource = navMenuList;
        ...
        private void ExpandToggleCLick(object sender, RoutedEventArgs e) {
            RootSplitView.IsPaneOpen = !RootSplitView.IsPaneOpen;
        }

        #region Everything handling "Go back"
        ...
        private void NavMenuList_ItemInvoked(object sender, ListViewItem listViewItem) {
            ...
            if(item != null) {
                if(item.DestPage != null && item.DestPage != ContentFrame.CurrentSourcePageType) {
                    ContentFrame.Navigate(item.DestPage, item.Arguments);
                }
            }
        }
        ...
        private void OnNavigatingToPage(object sender, NavigatingCancelEventArgs e) {
            if (e.NavigationMode == NavigationMode.Back) {
                var item = (from p in this.navMenuList where p.DestPage == e.SourcePageType select p).SingleOrDefault();
                if (item == null && this.ContentFrame.BackStackDepth > 0) {
                    ...
                    foreach (var entry in this.ContentFrame.BackStack.Reverse()) {
                        item = (from p in this.navMenuList where p.DestPage == entry.SourcePageType select p).SingleOrDefault();
                        if (item != null)
                            break;
                    }
                }
